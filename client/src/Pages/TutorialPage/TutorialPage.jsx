...
import { prevStep, updateStepsSeen } from "../../lib/Slices/tutorialSlice";
...
const TutorialPage = () => {
  ...
  useEffect(() => {
    dispatch(updateStepsSeen(currentStep));
  }, [currentStep]);
  return (
    <section
      className={`relative flex justify-center items-center h-screen  bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800 overflow-hidden`}
    >
      {/* previous button of the tutorial page */}
      {currentStep > 0 && (
        <button
          onClick={() => {
